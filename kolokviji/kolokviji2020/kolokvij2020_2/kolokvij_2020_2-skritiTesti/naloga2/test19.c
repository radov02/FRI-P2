...
int __main__() {
    int* t[] = {
        (int[]) {2437, 3220, 2817, 8583, 2875, 3988, -1},
        (int[]) {8024, 8549, 8747, 8410, 6516, 3957, -1},
        (int[]) {3520, 9649, 7337, 9301, 8724, 5923, -1},
        (int[]) {8069, 7372, 6333, 1368, 2912, 501, -1},
        (int[]) {6753, 6945, 8861, 1084, 8374, 4280, -1},
    };
